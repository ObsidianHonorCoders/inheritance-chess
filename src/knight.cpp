...
void Knight::moves(Piece::PositionList& p, const Piece::List other) const {}

void Knight::moves(Piece::PositionList& p, const Piece::PositionList other_p, const std::vector<Piece::Color> other_c) const {}
